    ...
    "resource": {
      ...
      "properties": {
        "resourceType" : {
          "enum": [
            "image",      // - A jpg, png, etc.
            "browsable",  // - A catch-all for things like social media posts,
                          //   or documents served up as a viewable page. Generally
                          //   resolves to something that generates viewable
                          //   html (i.e. a Graphite Doc or Travelstack Post).
            "other"       // - A catch-all for things that don't fit
                          //   above--i.e.: a JSON blob that needs decrypting
                          //   and prrocessing to be user friendly.
          ]
        },
        "title": {
      ...
      "additionalProperties": false,
      "required": [ "resourceType", "title", "relativePath", "utcTime", "version" ],
    },
    "encryption": {
